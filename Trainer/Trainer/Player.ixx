...
export enum class Character : int
{
	Nier_Young = 0x0,
	Nier_Prologue = 0x1,
	Nier_Old = 0x2,
...
export enum class GameFlags_5C8 : unsigned long long
{
...
export enum class GameFlags_5D8 : unsigned long long
{
...
export enum class Words_Uloth : unsigned long long
{
	Pah = 1ull << 0,
	Paha = 1ull << 1,
	Pahi = 1ull << 2,
...
export enum class Words_Zarken : unsigned long long
{
	Lug = 1ull << 0,
	Lugir = 1ull << 1,
	Luges = 1ull << 2,
...
export enum class Tutorials_7F0 : unsigned long long
{
	Controls = 1ull << 0,
	Combos = 1ull << 1,
	Dark_Blast = 1ull << 2,
...
export enum class Tutorials_7F8 : unsigned long long
{
...
export enum class Cultivation_Plant : signed char
{
	Empty = -1,
	Tomato = 0,
	Eggplant = 1,
...
export enum class Cultivation_Fertilizer : int
{
	None = 0,
	Speed = 1,
	Flowering = 2,
...
export enum class Cultivation_Action_Flags : unsigned char
{
	None = 0,
	Stage_1 = 1u << 0,
	Stage_2 = 1u << 1,
...
export struct Cultivation_Plot
{
...
export enum class SnowGameFlags_C48 : unsigned long long
{
...
export struct Player
{
	...
	unsigned long long item_collection_flags[12];
	unsigned long long item_new_flags[12];
